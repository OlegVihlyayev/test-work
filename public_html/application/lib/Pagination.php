...
class Pagination
{
    ...
    public function __construct($route, $total, $limit = 10, $column = '')
    {
        $this->route = $route;
        $this->total = $total;
        $this->limit = $limit;
    ...
    private function generateHtml($page, $text = null)
    {
        ...
        if (empty(!$this->column)) {
            return '<li class="page-item"><a class="page-link" href="/' . $this->route['controller'] . '/' . $this->route['action'] . '/' . $this->column . '/' . $page . '">' . $text . '</a></li>';
        }
